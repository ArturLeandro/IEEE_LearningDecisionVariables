...
def generateSpreadSheets(problem_labels, scales, num_objectives=3, times=20):
    for problem_label in problem_labels:      
        ...
        for scale in scales:
            ...
            if not os.path.exists('Results'):
                ...
                os.makedirs('./Results')
            var2.to_excel('./Results/regression_exp_'+problem_label+'_'+str(num_objectives)+'_'+str(scale)+'.xlsx',header=False, index=False)
...
#generateSpreadSheets(problem_labels, scales, num_objectives=3, times=1)